...
rightTalonFollower = new WPI_TalonFX(3);
    ...
    pidgeon = new PigeonIMU(5);
    pidgeon.clearStickyFaults();
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Pigeon Compass", pidgeon.getCompassHeading());
        SmartDashboard.putNumber("Pigeon Fused Heading", pidgeon.getFusedHeading());
