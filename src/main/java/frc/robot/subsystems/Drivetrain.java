...
public class Drivetrain extends Subsystem {
    ...
    private double speed = .25; //Percentage of the max speed the robot is able to use
    ...
    leftTalonLead = new TalonFX(0);
    leftTalonFollower = new TalonFX(1);
    rightTalonLead = new TalonFX(2);
    rightTalonFollower = new TalonFX(3);
