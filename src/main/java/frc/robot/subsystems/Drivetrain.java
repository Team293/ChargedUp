...
public class Drivetrain extends SubsystemBase {
    ...
    /**
     * Creates a new Drivetrain. This is the main class for the drivetrain
     * subsystem.
     * 
     * @param kinematics
     */
    ...
    /**
     * Sets the mode of the motor controllers. This means that the motor controllers
     * will be set to coast or brake mode.
     * 
     * @param nm
     */
    ...
    /**
     * Sets the motor controllers to the percent power. This is relatively dangerous
     * and is subject to internal motor issues as well as wear and tear on the motor
     * controllers. The problem with this is that 100% power on the motors may not
     * be equal.
     * 
     * @param leftPercentage  a value between -1.0 and 1.0
     * @param rightPercentage a value between -1.0 and 1.0
     */
    ...
    /**
     * Sets the motor controllers to the velocity. This is the preferred method of
     * driving the robot. This method will use the PID loop on the motor controllers
     * to drive the robot at the desired velocity.
     * 
     * @param velocity a value in feet per second
     * @param turning  an angle in radians
     */
    ...
    /**
     * Force-stops the motors. This is a hard stop and will not allow the robot to
     * coast to a stop. This is potentially dangerous and should only be used in
     ...
     * Sets the motor controllers to the velocity. This is the preferred method of
     * driving the robot. This method will use the PID loop on the motor controllers
     * to drive the robot at the desired velocity. This method will also limit the
     * acceleration of the robot to prevent wheel slip.
     * 
     * @param newVelocityL a value in encoder units per 100ms
     * @param newVelocityR a value in encoder units per 100ms
     */
    ...
    /**
     * returns the gyro yaw in degrees
     * 
    ...
    /**
     * calibrates the gyro and resets the yaw, then resets the gyro to the given
     * heading
     * 
     * @param gyro                 the gyro to calibrate
     * @param startingAngleDegrees the angle to reset the gyro to
     */
    ...
    /**
     * resets the gyro to the given heading
     * 
     * @param headingDegrees the angle to reset the gyro to
     */
    ...
    /**
     * gets the motor error from the left talon motor
     * 
     * @return motor error
     */
