...
public class Drivetrain extends SubsystemBase {
    ...
    public double maxDecelerationLeft;
    public double maxDecelerationRight;


    private ForzaDrive m_forza;


    public void setForza(ForzaDrive forza) {
        m_forza = forza;
    }
    ...
    public void decelerationDrive() {
        if (currentVelocityLeft < 1.0 && currentVelocityRight < 1.0) {
            currentVelocityLeft = 0;
            currentVelocityLeft = 0;
        } else {
            double vL = currentVelocityLeft - maxDecelerationLeft;
            double vR = currentVelocityRight - maxDecelerationRight;
            velocityDrive(vL, vR);
        }
    
 
    currentVelocityLeft = getLeftEncoderVelocity();
    currentVelocityRight = getRightEncoderVelocity();
    double speed = m_forza.m_currentSpeed;
    double turning = m_forza.m_currentTurning;
    if (speed != 0 && turning != 0) {
        maxDecelerationLeft = currentVelocityLeft / 75;
        maxDecelerationRight = currentVelocityRight / 75;
    }
}
