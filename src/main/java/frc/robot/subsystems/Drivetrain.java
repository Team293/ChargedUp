...
public class Drivetrain extends SubsystemBase 
{
    ...
    public Drivetrain() 
    {
        ...
        m_differentialDrive = new DifferentialDrive(leftTalonLead, rightTalonLead);
    ...
    public void dumbDrive(double leftPos, double rightPos) 
    {
        ...
        leftTalonLead.set(TalonFXControlMode.PercentOutput,retval * m_velocityLimitPercentage);    

        retval = clampInput(rightPos, m_deadband);
        rightTalonLead.set(TalonFXControlMode.PercentOutput,retval * m_velocityLimitPercentage);    
    }
    ...
    public void velocityDrive(double leftPos, double rightPos, boolean useSlowModifier, boolean useReverse)
    {
        ...
        if(useSlowModifier)
        {
            leftTalonLead.set(TalonFXControlMode.Velocity,(retval * MAX_VELOCITY * m_velocityLimitPercentage * VELOCITY_SLOWDOWN_MODIFIER));    
        } 
        else 
        {
            leftTalonLead.set(TalonFXControlMode.Velocity,(retval * MAX_VELOCITY * m_velocityLimitPercentage));
        }

        retval = clampInput(rightPos, m_deadband);
        if(useSlowModifier)
        {
            rightTalonLead.set(TalonFXControlMode.Velocity,(retval * MAX_VELOCITY * m_velocityLimitPercentage * VELOCITY_SLOWDOWN_MODIFIER));    
        } 
        else 
        {
            rightTalonLead.set(TalonFXControlMode.Velocity,(retval * MAX_VELOCITY * m_velocityLimitPercentage));
        }
    }
