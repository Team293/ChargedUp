...
public class Launcher extends Subsystem {
    ...
    public final int realworldError = -47;
    private final int TARGET_RPM = 2500 + realworldError;
...
launcherMotor = new WPI_TalonSRX(10);
    ...
    public void enableLauncher(){
        int targetRPM = (int)SmartDashboard.getNumber("Target RPM", 0);
    ...
    public boolean isReady(double velSpeed) {
        ...
        if ((currentRPM + TARGET_DEADBAND >= (TARGET_RPM)) && (currentRPM - TARGET_DEADBAND <= (TARGET_RPM))) {
