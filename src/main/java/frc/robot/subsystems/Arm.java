...
public class Arm extends SubsystemBase {
    ...
    /**
     * Get the current encoder units of the pivot motor.
     */
    ...
    /**
     * Get the current encoder units of the extender motor.
     */
    ...
    /**
     * Adjusts the position of the arm by a given percentage of the maximum delta.
     * 
     * @param anglePercent  - percentage of the maximum angle delta
     * @param extendPercent - percentage of the maximum extension delta
     */
    ...
    /**
     * Sets the encoder units of the pivot motor.
     */
    ...
    /**
     * Sets the encoder units of the extender motor.
     */
    ...
    /**
     * Invalidates the calibration of the pivot motor, which will cause it to
     * recalibrate.
     */
    ...
    /**
     * Returns whether the pivot motor is calibrated.
     */
    public boolean getPivotCalibration() {
        return isPivotCalibrated;
    }

    /**
     * Invalidates the calibration of the extender motor, which will cause it to
     * recalibrate.
     */
    ...
    /**
     * Returns whether the extender motor is calibrated.
     */
    public boolean getExtenderCalibration() {
        return isExtenderCalibrated;
    }

    /**
     * Checks if the extender motor is calibrated and does nothing if
     * isExtenderCalibrated is true. If false, once the reverse extender limit
     * switch is tripped the extender motor is stopped, and the position is set
     */
    ...
    /**
     * Checks if the pivot motor is calibrated and does nothing if isPivotCalibrated
     * is true. If false, once the reverse pivot limt switch is tripped the pivot
     * motor is stopped, and the position is set
     */
    ...
    /**
     * Returns whether the arm is calibrated.
     */
    ...
    /**
     * Returns the current extension of the arm in inches.
     */
