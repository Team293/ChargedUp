...
public class Drive extends SubsystemBase {
  ...
  private static final double KS = Constants.currentMode == Mode.SIM ? 0.0 : 0.6;
  private static final double KV = Constants.currentMode == Mode.SIM ? 0.227 : 2.3423;
  private static final double KA = Constants.currentMode == Mode.SIM ? 0.0 : 0.35;
