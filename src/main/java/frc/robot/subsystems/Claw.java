...
public class Claw extends SubsystemBase {
    ...
    public final double SCORE_HYBRID_X_INCHES = 20.0d; // TODO: Low: Find the value for how far the extension motor has to extend in inches.  
    ...
    public final double SHOULDER_GEARBOX_RATIO = 4.0d / 100.0d;
