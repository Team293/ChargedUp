...
public class Claw extends SubsystemBase {
    ...
    private double percentLimitPercentage = 0.005;
    ...
    public Claw() {
        ...
        SmartDashboard.putNumber("Claw Percent Output", percentLimitPercentage);
    }

    @Override
    public void periodic() {
        percentLimitPercentage = SmartDashboard.getNumber("Claw Percent Output", percentLimitPercentage);
        percentLimitPercentage = MathUtil.clamp(percentLimitPercentage, -0.5, 0.5);
    }

    public void percentClaw(double percentage) {
        clawTalonFX.set(ControlMode.PercentOutput, percentage * percentLimitPercentage);
    }
}
