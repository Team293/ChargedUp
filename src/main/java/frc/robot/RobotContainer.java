...
public class RobotContainer 
{
    ...
    */
    private RobotContainer() 
    {
        ...
        SmartDashboard.putData("ToggleShooterPiston", new ToggleShooterPiston(m_launcher));
    ...
    private void configureButtonBindings() 
    {
        ...
        final JoystickButton toggleShooterPistonBtn = new JoystickButton(operatorLeftJoy, 2);
        toggleShooterPistonBtn.whenPressed(new ToggleShooterPiston(m_launcher), true);
        SmartDashboard.putData("toggleShooterPistonBtn", new ToggleShooterPiston(m_launcher));
