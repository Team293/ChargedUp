...
public class RobotContainer 
{
    ...
    */
    private RobotContainer() 
    {
        ...
        m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand(m_drivetrain, m_kinematics, startPosition.RIGHT, m_feeder, m_launcher, m_ballPickup));
        m_chooser.addOption("Right", new AutonomousCommand(m_drivetrain, m_kinematics, startPosition.RIGHT, m_feeder, m_launcher, m_ballPickup));
        m_chooser.addOption("Middle", new AutonomousCommand(m_drivetrain, m_kinematics, startPosition.MIDDLE, m_feeder, m_launcher, m_ballPickup));
        m_chooser.addOption("Left", new AutonomousCommand(m_drivetrain, m_kinematics, startPosition.LEFT, m_feeder, m_launcher, m_ballPickup));
