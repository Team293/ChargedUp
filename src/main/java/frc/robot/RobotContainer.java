...
private final Joystick leftJoy = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("LocateTarget", new LocateTarget( m_drivetrain ));
    SmartDashboard.putData("BeltMove", new BeltMove( m_feeder ));
    SmartDashboard.putData("Fire", new Fire( m_feeder ));
    ...
    SmartDashboard.putData("ToggleGecko", new ToggleGecko( m_ballPickup ));
    SmartDashboard.putData("SmartLauncher", new SmartLauncher( m_launcher ));
    SmartDashboard.putData("GeckoDown", new GeckoDown( m_ballPickup ));
    SmartDashboard.putData("GeckoUp", new GeckoUp( m_ballPickup ));
...
geckoUpBtn.whenPressed(new GeckoUp( m_ballPickup ) ,true);
    SmartDashboard.putData("geckoUpBtn",new GeckoUp( m_ballPickup ) );
...
locateTargetBtn.whileHeld(new LocateTarget( m_drivetrain ) ,true);
    SmartDashboard.putData("locateTargetBtn",new LocateTarget( m_drivetrain ) );

final JoystickButton disableLauncherBtn = new JoystickButton(operatorLeftJoy, 12);        
disableLauncherBtn.whenPressed(new DisableLauncher( m_launcher ) ,true);
    SmartDashboard.putData("disableLauncherBtn",new DisableLauncher( m_launcher ) );

final JoystickButton enableLauncherBtn = new JoystickButton(operatorLeftJoy, 11);        
enableLauncherBtn.whenPressed(new EnableLauncher( m_launcher ) ,true);
    SmartDashboard.putData("enableLauncherBtn",new EnableLauncher( m_launcher ) );

final JoystickButton fireBtn = new JoystickButton(operatorLeftJoy, 1);        
fireBtn.whileHeld(new Fire( m_feeder ) ,true);
    SmartDashboard.putData("fireBtn",new Fire( m_feeder ) );

final JoystickButton locateBtn = new JoystickButton(leftJoy, 1);        
locateBtn.whileHeld(new LocateTarget( m_drivetrain ) ,true);
    SmartDashboard.putData("locateBtn",new LocateTarget( m_drivetrain ) );
