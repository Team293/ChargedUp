...
public class RobotContainer 
{
    ...
    */
    ...
    private void configureButtonBindings() 
    {
        ...
        //final JoystickButton xboxFireBtn = new JoystickButton(driveController, XboxController.Button.kBumperRight.value);
        
        /*Raise the launcher piston
        final POVButton dpadUpButton = new POVButton(driveController, 0);
        dpadUpButton.whenPressed(new ShooterPistonUp(m_launcher));

        //Lower the launcher piston
        final POVButton dpadDownButton = new POVButton(driveController, 180);
       ...
       //final JoystickButton xboxFireBtn.whileHeld(new Fire(m_feeder, m_launcher, m_launcherController));
       ...
       /*final JoystickButton xboxTargetBtn = new JoystickButton(driveController, XboxController.Button.kBumperLeft.value);
        ...
        final JoystickButton xboxTargetBtn = new JoystickButton(operatorController, XboxController.Button.kBumperLeft.value);
        xboxTargetBtn.whileHeld(    new LocateTarget(m_drivetrain, m_targeting));
         

        //Wheel Spin Up Mapping
        final JoystickButton blueZoneBtn = new JoystickButton(driveController, XboxController.Button.kX.value); // button needs to be swithced
        blueZoneBtn.whenPressed(new SetBlueZone(m_launcherController));
        ...
        //Pickup Feeder Mapping
         ...
         //Gecko Down
         final JoystickButton geckoDownBtn = new JoystickButton(operatorController,XboxController.Button.kB.value );        
         geckoDownBtn.whenPressed(new GeckoDown( m_ballPickup ) ,true);
         SmartDashboard.putData("geckoDownBtn",new GeckoDown( m_ballPickup ) ); // Gecko should go up when the button is pressed similar to setZones
