...
public JoystickButton geckoOnBtn;
public JoystickButton geckoOffBtn;
...
geckoOffBtn = new JoystickButton(operatorRightJoy, 10);
geckoOffBtn.whenPressed(new GeckoStop());
geckoOnBtn = new JoystickButton(operatorRightJoy, 9);
geckoOnBtn.whenPressed(new SetGeckoSpeed());
