...
public JoystickButton geckoPivotDownButton;
public JoystickButton geckoPivotUpButton;
public JoystickButton geckoFeedBtn;
public JoystickButton geckoStopBtn;
...
geckoPivotDownButton.whenPressed(new GeckoPivotDown());
        ...
        SmartDashboard.putData("GeckoPivotDown", new GeckoPivotDown());
        SmartDashboard.putData("GeckoPivotUp", new GeckoPivotUp());
        SmartDashboard.putData("SetGeckoSpeed", new SetGeckoSpeed());
        SmartDashboard.putData("GeckoStop", new GeckoStop());
