...
public abstract class SpikeMotor {
     ...
     * @see #setPidImpl()
     */
    public final void setPid(int slotId, double kP, double kI, double kD, double kF, double izone) {
        if (!isInitialized) {
            throw new IllegalStateException(
                    "Motor must be initialized first");
        }
     ...
     * @see #setPid()
     */
    abstract protected void setPidImpl(int slotId, double kP, double kI, double kD, double kF, double izone);
