...
public class AutonomousCommand extends CommandBase 
{
    ...
    public AutonomousCommand(Drivetrain drivetrain, Kinematics kinematics, Enum startPosition, Feeder feeder, Launcher launcher, BallPickup ballPickup) 
    {
    ...
    {
        if(m_startPosition == startPosition.LEFT)
        {

        }
        else if(m_startPosition == startPosition.MIDDLE)
        {

        }
        else if(m_startPosition == startPosition.RIGHT)
        {
