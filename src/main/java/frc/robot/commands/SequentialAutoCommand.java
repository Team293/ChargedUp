        ...
        switch (m_startPosition) { // Changes the robot path based on the starting position of the robot Left,
            ...
            case BLUE_MIDDLE:
                addCommands(
                        ...
                        new ResetKinematics(new Position2D(-5.350, -5.363, Math.toRadians(0)), m_drivetrain,
                                m_kinematics),
                        // Auto balances the robot on charging station
            ...
            case BLUE_RIGHT:
                addCommands(
                        ...
                        new ResetKinematics(new Position2D(-1.995, -7.628, Math.toRadians(0)), m_drivetrain,
                                m_kinematics)
                       );
                break;
